...
(function () {
  ...
  $('#recalibBtn')?.addEventListener('click', (e) => {
    ...
    if (headless) {
      // Modal partagé défini dans recalib.js
      if (window.DartApp.openRecalibModal) {
        window.DartApp.openRecalibModal();
      } else {
        console.error('recalib.js pas chargé');
      }
    } else {
  ...
  // ═══════════════════════════════════════════════════════════════════
  // MODAL RECALIBRATION → délégué à recalib.js (DartApp.openRecalibModal)
  // (Le code est partagé avec /game qui appelle aussi cette fonction.)
  // ═══════════════════════════════════════════════════════════════════
})();
